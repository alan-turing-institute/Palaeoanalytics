...
- [👥 The team ](#-the-team-)
- [📦 The `PyLithics` package ](#-the-pylithics-package-)
  - [Workflow](#workflow)
  - [Installation](#installation)
  - [Running `PyLithics`](#running-pylithics)
  - [💫 Quickstart](#-quickstart)
  - [Output from `PyLithics`](#output-from-pylithics)
...
| --- | --- | --- | --- |
| Dr. Jason Gellis | Senior Data Scientist (Dimensions AI) & Researcher (University of Cambridge) | [jg760@cam.ac.uk](mailto:jg760@cam.ac.uk) | [@JasonGellis](https://github.com/JasonGellis) |
| Dr. Camila Rangel Smith | Research Data Scientist (The Alan Turing Institute) | [crangelsmith@turing.ac.uk](mailto:crangelsmith@turing.ac.uk) |[@crangelsmith](https://github.com/crangelsmith) |
| Prof. Robert Foley | Principal Investigator (University of Cambridge) | [raf10@cam.ac.uk](mailto:raf10@cam.ac.uk)| [Rob-LCHES](https://github.com/Rob-LCHES)
...
- *scale_id*: The scale id (name of the scale image file) - optional for pixel-only measurements
...
- **Pixel Measurements**: Raw pixel measurements when no scale calibration is available
...
The config is optimized to work with the images in an [example dataset](data). If you want to use `PyLithics` with different styles of
...
Every time a change in the `PyLithics` code is pushed to the Palaeoanalytics repository, the [`travis.yml`](.travis.yml)
